...
export default function ProductCard({product}) { 
  ...
  <div className='relative border border-gray-100 rounded-2xl cursor-pointer hover:scale-105  hover:shadow-2xl transition-all p-2 h-max'>
    ...
    <button onClick={()=>addToCart(product)} className="flex items-center gap-2 bg-red-500 text-white px-2 py-1 rounded-md font-semibold text-lg w-full cursor-pointer"><span><IoCartOutline className="w-6 h-6"/></span> Add to Cart</button>  
  </div>
