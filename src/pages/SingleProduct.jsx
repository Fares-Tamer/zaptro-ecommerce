                ...
                <div className='max-w-6xl mx-auto md:p-6 grid md:grid-cols-2 gap-10'>
                    ...
                    <div>
                        ...
                        <div className='flex gap-4 mt-4'>
                                <button onClick={()=>addToCart(productData)} className='px-6 flex gap-2 py-2 text-lg bg-red-500 text-white rounded-md cursor-pointer'><IoCartOutline className='w-6 h-6'/> Add to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
